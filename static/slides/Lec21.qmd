...
![](imgs/Lec21/ndvi_cameroon.png){fig-align="center" width="50%"}
...
$$
\begin{aligned}
\boldsymbol{y}_{\cdot l k}|\boldsymbol{\Theta} &\sim N\left(\textstyle\sum_i y_{ilk},\: \boldsymbol{f}_{\cdot l k}\right) \\
\\
